            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3">Keranjang Buku</h1>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                <div class="col-md-12">
                                ...
                                <table class="table table-border">
                                    ...
                                    <?php foreach (@$_SESSION['cart'] as $no=>$no_produk):?>
                                    <tr>
                                        <td><?=($no+1)?></td>
                                        <td><?=$no_produk['judul']?></td> 
                                        <td><?=$no_produk['stok']?></td>
                                        <td><a href="aksi/hapus-cart.php?ID=<?=$no?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus Buku Tersebut?')">Hapus<i class="faa fa-trash-alt"></i></a></td>
                                    </tr>
                                    <?php endforeach;?>
                                </table>
                                <div class="col-md-12">
                                    <a href="aksi/aksi-pinjam.php" class="btn btn-primary mb-4">Confrim</a>
                                </div>
                        </div>
                    </div>  
                </main>
