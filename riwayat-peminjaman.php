            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3">Laporan Peminjaman</h1>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                <div class="col-md-12">  
                                    <a href="laporan.php" class="btn btn-primary"><i class="fa fa-print"></i>Cetak Laporan</a>   
                                </div>
                                <table class="table table-border">
                                    ...
                                    <?php
                                        $query=mysqli_query($con, "SELECT * FROM peminjaman JOIN user on user.userID=peminjaman.userID JOIN buku on buku.bukuID=peminjaman.bukuID  order by peminjamanID asc ");
                                        $no=0;
