            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3">Pengembalian</h1>
                    </div>
                    <?php
                        $id=$_GET['peminjamanID'];
                        $ubah=mysqli_query($con,"SELECT*FROM peminjaman JOIN buku on buku.bukuID=peminjaman.bukuID WHERE peminjamanID='$id'");
                        while($data=mysqli_fetch_array($ubah)){
                    ?>
                    <form action="aksi/aksi-ubah-pinjam.php?peminjamanID=<?=$data['peminjamanID']?>" method="post">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <select name="status" class="form-control">
                                            <option value="<?php echo $data['status']?>">Pinjam</option>
