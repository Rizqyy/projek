<?php
    ...
    if(!isset($_SESSION['user']) || $_SESSION['level'] !== 'pengguna'){
        header('location:peminjaman-admin.php'); // Redirect user if session user is not set or level is not 'pengguna'
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                <table class="table table-border">
                                    ...
                                    <?php
                                        $query=mysqli_query($con, "SELECT * FROM peminjaman JOIN user on user.userID=peminjaman.userID JOIN buku on buku.bukuID=peminjaman.bukuID  WHERE peminjaman.userID='{$_SESSION['userID']}' order by peminjamanID asc ");
                                        $no=0;
