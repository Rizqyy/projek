                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="row m-4">
                                <?php
                                    $judul=mysqli_query($con, "SELECT * FROM koleksipribadi JOIN user on user.userID=koleksipribadi.userID JOIN buku on buku.bukuID=koleksipribadi.bukuID order by koleksiID asc"); 
                                ...
                                <img src="assets/img/<?php echo $buku['foto'];?>" class="cart-img-top">
                                    ...
                                    ?>
                                        ...
                                        <a class="btn btn-outline-danger" href="aksi/hapus-fav.php?koleksiID=<?php echo $buku['koleksiID']?>"><i class="fa fa-bookmark"></i></a>
                                    <?php
                                    }?>
                                    </div>
                                </div>
