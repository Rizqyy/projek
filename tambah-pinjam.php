            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3">Peminjaman</h1>
                    </div>
                    <?php
                        $id=$_GET['bukuID'];
                        $judul=mysqli_query($con,"SELECT*FROM buku WHERE bukuID='$id'");
                        while($buku=mysqli_fetch_array($judul)){
                    ?>
                    <form action="aksi/simpan-keranjang.php?bukuID=<?=$buku['bukuID']?>" method="post">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-2">Judul</div>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="bukuID" value="<?php echo $buku['judul'];?> "readonly>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" name="jumlah" value="1" max="2" min="1">
                                    </div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                    <button type="submit" class="btn btn-primary" name="submit">Simpan</button>
                                    <a class="btn btn-info" href="buku.php">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </form>
